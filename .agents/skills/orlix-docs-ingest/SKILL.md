...
description: >-
  Add or update Orlix knowledge in the canonical docs ontology. Use for
  architecture, decision, epic, story, task, capability, terminology,
  provenance, and durable lesson changes.
---
# Orlix Docs Ingest
...
5. Use `python3 .rulesync/skills/orlix-docs-ingest/scripts/wiki_link_repair.py --dry-run` before a rename or move.
