...
description: Orlix TCTI debugging with native LLDB and kernel-owned C proof. Use for crashes, watchpoints, disassembly, ELF, Mach-O, instruction encodings, symbols, sections, relocations, and TCTI runtime corruption.
---
# Orlix TCTI Debug
