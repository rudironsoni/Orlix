...
description: >-
  ...
  OrlixKit, OrlixEngine, OrlixOS, OrlixInstance, OrlixContainer, Herdr,
  OrlixTCTI, OrlixHostAdapter, the native Orlix app, upstream Linux, upstream
  mlibc, packages, product payloads, session APIs, or generated trees. Routes
  fixes to the correct layer and blocks wrong-layer shortcuts.
---
