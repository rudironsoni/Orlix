...
name: orlix-planner
description: >-
  Plans non-trivial Orlix work by creating or refining typed initiative and architecture-decision pages. Does not implement.
codexcli:
...
Return concrete edits for the owning initiative page. Keep durable objectives, scope, exclusions, ownership, milestones, proof boundaries, and verification gates in the ontology. Keep current execution status, selected commands, and evidence in structured harness reports. Never create `PLAN.md`, `IMPLEMENT.md`, or a chronological implementation journal.
