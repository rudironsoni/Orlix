...
extern int exec_syscall_contract_elf_stack_growth_tracks_smaps_dirty_page(void);
...
- (void)testElfStackGrowthTracksSmapsDirtyPage {
    XCTAssertEqual(exec_syscall_contract_elf_stack_growth_tracks_smaps_dirty_page(), 0, @"errno %d", errno);
}
