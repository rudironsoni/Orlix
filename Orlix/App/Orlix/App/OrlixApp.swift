...
struct OrlixApp: App {
    ...
    @StateObject private var remoteFileBrowserStore = OrlixApp.makeRemoteFileBrowserStore()
...
#if os(iOS)
private enum OrlixLauncherWidgetRefresh {
    ...
    static func refreshIfNeeded() {
        ...
        WidgetCenter.shared.reloadTimelines(ofKind: OrlixWidgetKind.launcher)
        defaults.set(renderingRevision, forKey: renderingRevisionKey)
    }
}
#endif

private extension OrlixApp {
