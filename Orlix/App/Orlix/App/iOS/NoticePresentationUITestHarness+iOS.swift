...
struct NoticePresentationUITestHarness: View {
    private var showsFilesPreviewScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-notice-files-preview")
    }

    private var showsConnectingScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-notice-connecting")
    }

    private var showsReconnectBannerScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-notice-reconnect-banner")
    }

    private var showsOperationStackScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-notice-operation-stack")
    }

    private var showsConnectionSheetHandoffScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-connection-sheet-handoff")
    }

    private var showsInactiveConnectionSheetScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-inactive-connection-sheet")
    }
...
private struct InactiveConnectionSheetHarness: View {
    var body: some View {
        ...
        .accessibilityIdentifier("orlix.noticeTest.inactiveConnectionSheet")
...
private struct ConnectionSheetHandoffHarness: View {
    ...
    var body: some View {
        ...
        .task {
            // XCTest launch synchronization can outlast a short transition and
            // miss the connecting sheet entirely. Keep the debug harness in
            // its initial state long enough for the UI test to observe it.
                ...
                .toolbar {
                    ToolbarItem(placement: .bottomBar) {
                        Button("Upload", systemImage: "arrow.up.doc") {}
                            .accessibilityIdentifier("orlix.noticeTest.bottomToolbar")
                    }
                }
            }
        }
...
private struct NoticeReconnectBannerHarness: View {
    ...
    var body: some View {
        ...
        .accessibilityIdentifier("orlix.noticeTest.reconnectBanner")
        .preferredColorScheme(.dark)
    }
}
...
private struct NoticeConnectionFailureHarness: View {
    var body: some View {
        ...
        .accessibilityIdentifier("orlix.noticeTest.connectionFailure")
        .preferredColorScheme(.dark)
    }
}
        ...
        NavigationStack {
            ...
            .navigationDestination(isPresented: $showsPreview) {
                NoticeHost(bottomOperation: noticeHost.bottomOperation) {
                    ...
                    .accessibilityIdentifier("orlix.noticeTest.filesPreview")
                }
