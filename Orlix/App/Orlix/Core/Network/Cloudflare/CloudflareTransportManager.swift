...
actor CloudflareTransportManager {
    ...
    private let callbackScheme = "orlix-cfaccess"
    private let userAgent = "Orlix"
    private let discoveryTimeout: TimeInterval = 12
    private let disconnectTimeout: Duration = .seconds(4)
    private let metadataKeychain = KeychainStore(service: "com.rudironsoni.Orlix.cloudflare.metadata")
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.rudironsoni.Orlix", category: "CloudflareTransport")
