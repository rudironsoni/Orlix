...
actor SSHClient {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.rudironsoni.Orlix", category: "SSH")
...
actor SSHSession {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.rudironsoni.Orlix", category: "SSHSession")
