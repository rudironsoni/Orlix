...
final class AppLockManager: ObservableObject {
    ...
    func requestSetFullAppLockEnabled(_ enabled: Bool) async {
        ...
        let reason = String(format: String(localized: "Enable %@ for Orlix"), biometryDisplayName)
    ...
    func ensureAppUnlocked() async -> Bool {
        ...
        let reason = String(format: String(localized: "Unlock Orlix with %@"), biometryDisplayName)
