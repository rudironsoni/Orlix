...
struct GeneralSettingsView: View {
    ...
    @AppStorage(AnalyticsTracker.enabledKey) private var analyticsEnabled = false
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Toggle(
                    String(format: String(localized: "Require %@ to open Orlix"), appLockManager.biometryDisplayName),
                    isOn: Binding(
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text("Help Improve Orlix shares anonymous product statistics only when Orlix analytics are explicitly configured and enabled.")
