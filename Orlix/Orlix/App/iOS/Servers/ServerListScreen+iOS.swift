    ...
    var body: some View {
        ...
        .toolbar {
            ...
            ToolbarItem(placement: .navigationBarLeading) {
                ...
                .accessibilityIdentifier("orlix.serverList.settings")
            }
        }
            ...
            if filteredServers.isEmpty {
                ...
                ForEach(filteredServers) { server in
                    ...
                    .accessibilityIdentifier(
                        "orlix.serverList.server.\(server.id.uuidString)"
                    )
                }
            }
        } header: {
        ...
        if !activeConnections.isEmpty && !filteredServers.isEmpty {
            Section {
                ForEach(activeConnections) { connection in
                    ...
                    .accessibilityIdentifier(
                        "orlix.serverList.activeConnection.\(connection.id.uuidString)"
                    )
                }
            } header: {
