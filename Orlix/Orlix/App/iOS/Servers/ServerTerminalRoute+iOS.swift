...
struct ServerTerminalRoute: View {
    ...
    @SceneStorage("orlix.zenMode.ios") private var isZenModeEnabled = false
                ...
                if let server = selectedServer {
                    if selectedView == .terminal {
                        ...
                        if canEnterZenMode {
                            ...
                            .accessibilityIdentifier("orlix.terminal.enterZenMode")
                        }
                    ...
                    .accessibilityIdentifier("orlix.terminal.duplicateServer")
                    ...
                    .accessibilityIdentifier("orlix.terminal.settings")
    ...
    private func floatingKeyboardControl(showsTitle: Bool) -> some View {
        TerminalFloatingControlButton.keyboard(
