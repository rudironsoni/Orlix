...
struct NoticePresentationUITestHarness: View {
    private var connectionStatusScenario: NoticeConnectionStatusHarness.Scenario {
        ...
        if arguments.contains("--orlix-ui-test-notice-disconnected") {
            return .disconnected
        }
        if arguments.contains("--orlix-ui-test-notice-host-key") {
    ...
    private var showsDiagnosticDetailScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-notice-diagnostics")
    }

    private var showsConnectionBannerHandoffScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-connection-banner-handoff")
    }

    private var showsInactiveConnectionBannerScenario: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-inactive-connection-banner")
    }
...
private struct InactiveConnectionBannerHarness: View {
    ...
    var body: some View {
        ...
        .accessibilityIdentifier("orlix.noticeTest.inactiveConnectionBanner")
        .preferredColorScheme(.dark)
    }
}
