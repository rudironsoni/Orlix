...
struct TerminalKeyboardUITestHarness: View {
    ...
    private static let clearTerminalBackgroundCacheForUITest: Void = {
        guard Foundation.ProcessInfo.processInfo.arguments.contains(
            "--orlix-ui-test-clear-terminal-background-cache"
        ) else {
            return
        }
    ...
    private static let touchSelectionFixture = Data(
        (
            (0..<40)
                .map { "Orlix local selection fixture \($0)" }
                .joined(separator: "\r\n") + "\r\n"
        ).utf8
    )
    ...
    private var preservesTerminalSize: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-preserve-terminal-size")
    }

    private var simulatesKeyboardFrames: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-simulate-keyboard-frames")
    }

    private var simulatesCodexTUIResponse: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-codex-tui-response")
    }

    private var simulatesTerminalMouseCapture: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-terminal-mouse-capture")
    }

    private var seedsTerminalSelectionFixture: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-terminal-selection-fixture")
    }

    private var seedsTerminalPasteboard: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains("--orlix-ui-test-terminal-pasteboard")
    }

    private var testsAppShortcutInputs: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains(
            "--orlix-ui-test-terminal-app-shortcut-inputs"
        )
    }

    private var simulatesTerminalMetadataChurn: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains(
            "--orlix-ui-test-terminal-metadata-churn"
        )
    }
    ...
    private var simulatesStaleLightAccessoryCacheOnResume: Bool {
        Foundation.ProcessInfo.processInfo.arguments.contains(
            "--orlix-ui-test-stale-light-accessory-cache-on-resume"
        )
    }
    ...
    var body: some View {
        ZStack(alignment: .topLeading) {
            if showsTerminal {
                ...
                .accessibilityIdentifier("orlix.keyboardTest.container")
            } else {
                nonTerminalSurface
            }
            ...
            if simulatesPrivacyShield {
                Color.black
                    .opacity(0.55)
                    .ignoresSafeArea()
                    .accessibilityIdentifier("orlix.keyboardTest.privacyShield")
            }
                ...
                VStack {
                    ...
                    HStack(spacing: 10) {
                        ...
                        if !voicePresentation.isRecording {
                            ...
                            .accessibilityIdentifier("orlix.terminal.floating.voiceInput")
                        }
                        ...
                        if voicePresentation.isPendingReturn {
                            ...
                            .accessibilityIdentifier("orlix.terminal.floating.return")
                        }
                        ...
                        if voicePresentation.isRecording {
                            ...
                            .accessibilityIdentifier("orlix.keyboardTest.voice.transcriptionSent")
                        }
                    }
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text(terminalReady ? "ready=true" : "ready=false")
                    .accessibilityIdentifier("orlix.keyboardTest.ready")
                Text(diagnostics)
                    .accessibilityIdentifier("orlix.keyboardTest.diagnostics")
                    .lineLimit(6)
            }
            ...
            VStack(alignment: .trailing, spacing: 6) {
                HStack(spacing: 8) {
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.mode.terminal")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.mode.other")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.hideViaToolbar")

                    Button("Keyboard") {
                        requestSoftwareKeyboard()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.showKeyboard")

                    Menu {
                        Button("Settings") {
                            presentSettings()
                        }
                        .accessibilityIdentifier("orlix.keyboardTest.menu.settings")

                        Button("Find") {
                            showFindInput()
                        }
                        .accessibilityIdentifier("orlix.keyboardTest.menu.find")

                        Button("Keyboard") {
                            requestSoftwareKeyboard()
                        }
                        .accessibilityIdentifier("orlix.keyboardTest.menu.showKeyboard")
                    } label: {
                        Text("More")
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.menu")

                    Button("Close Alert") {
                        requestPaneCloseConfirmation()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.closeAlert")
                ...
                HStack(spacing: 8) {
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.ime.mark")

                    Button("Del") {
                        terminalView?.keyboardUITestDeleteBackwardThroughIMEProxy()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.ime.delete")

                    Button("Commit") {
                        terminalView?.keyboardUITestCommitMarkedText()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.ime.commit")

                    Button("Hardware") {
                        terminalView?.keyboardUITestRequestHardwareKeyboardFocus()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.hardwareFocus")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.hardware.attach")

                    Button("HW Off") {
                        terminalView?.keyboardUITestSetHardwareKeyboardAttached(false)
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.hardware.detach")

                    Button("Lose Keyboard") {
                        terminalView?.keyboardUITestBeginUnexpectedSoftwareKeyboardLoss()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.keyboard.unexpectedLoss")
                }
                ...
                HStack(spacing: 8) {
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.hardwareRepeat.begin.h")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.hardwareRepeat.begin.shiftH")

                    Button("Repeat Tick") {
                        terminalView?.keyboardUITestFireHardwareKeyRepeat()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.hardwareRepeat.tick")

                    Button("Repeat Release") {
                        terminalView?.keyboardUITestEndHardwareKeyRepeat()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.hardwareRepeat.release")

                    Button("Repeat Cancel") {
                        terminalView?.keyboardUITestCancelHardwareKeyRepeat()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.hardwareRepeat.cancel")
                }
                ...
                if testsAppShortcutInputs {
                    HStack(spacing: 8) {
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.shortcut.software.cmdD")
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.shortcut.software.cmdShiftD")
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.shortcut.software.cmdW")
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.shortcut.toolbar.cmdAltLeft")
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.shortcut.custom.cmdCtrlRight")
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.shortcut.custom.ctrlX")
                    }
                }
                ...
                .accessibilityIdentifier("orlix.keyboardTest.cursor.bottom")
                ...
                HStack(spacing: 8) {
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.window.notKey")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.window.key")

                    Button("Docked") {
                        applySimulatedKeyboardGeometry(.docked)
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.geometry.docked")

                    Button("Floating") {
                        applySimulatedKeyboardGeometry(.floating)
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.geometry.floating")

                    Button("No Frame") {
                        applySimulatedKeyboardGeometry(.hidden)
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.geometry.hidden")

                    Button("Foreign KB") {
                        simulateSameScreenForeignKeyboardFrame()
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.geometry.foreignDocked")
                }
                ...
                HStack(spacing: 8) {
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.scene.inactive")

                    Button("Active") {
                        lifecycleStatus = .connected
                        applyRouteActivation(.foregroundActive)
                    }
                    .accessibilityIdentifier("orlix.keyboardTest.scene.active")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.privacy.shield")
                    ...
                    .accessibilityIdentifier("orlix.keyboardTest.privacy.resume")
                }
            }
            ...
            NavigationView {
                ...
                .toolbar {
                    ToolbarItem(placement: .topBarTrailing) {
                        ...
                        .accessibilityIdentifier("orlix.keyboardTest.settings.close")
                    }
                }
            }
            .accessibilityIdentifier("orlix.keyboardTest.settings.sheet")
        }
        .task {
    ...
    private var nonTerminalSurface: some View {
        Button("Other Surface") { }
            ...
            .accessibilityIdentifier("orlix.keyboardTest.nonTerminalSurface")
    }
    ...
    private func refreshDiagnostics() {
        ...
        diagnostics = terminalDiagnostics + " " + keyboardAvoidanceDiagnostics(for: terminalView)
            ...
            + " mouseCaptured=\(terminalView.isMouseCapturedForHostInteraction)"
        ...
        ZStack(alignment: .topLeading) {
            HStack(spacing: 1) {
                terminalSurface(
                    ...
                    identifier: "orlix.keyboardTest.terminalSurface.first",
                ...
                terminalSurface(
                    ...
                    identifier: "orlix.keyboardTest.terminalSurface.second",
            ...
            HStack {
                ...
                .accessibilityIdentifier("orlix.keyboardTest.focus.first")
                Button("Pane B") {
                    focus(Self.secondPaneId)
                }
                .accessibilityIdentifier("orlix.keyboardTest.focus.second")
                Button("Keyboard") {
                    tabManager.keyboardCoordinator.userRequestedShow()
                }
                .accessibilityIdentifier("orlix.keyboardTest.showKeyboard")
            ...
            HStack(spacing: 8) {
                ...
                .accessibilityIdentifier("orlix.keyboardTest.command.cmdD")
                ...
                .accessibilityIdentifier("orlix.keyboardTest.command.cmdAltLeft")
                ...
                .accessibilityIdentifier("orlix.keyboardTest.command.cmdCtrlRight")
            }
            .buttonStyle(.borderedProminent)
            .padding(.top, 52)
            .padding(.trailing, 8)
            ...
            HStack(spacing: 8) {
                ...
                .accessibilityIdentifier("orlix.keyboardTest.padding.maximum")

                Button("Pad 0") {
                    applyContentPadding(0)
                }
                .accessibilityIdentifier("orlix.keyboardTest.padding.zero")
            }
            .buttonStyle(.borderedProminent)
            .padding(.top, 96)
            .padding(.trailing, 8)
...
struct TerminalKeyboardHarnessRepresentable: UIViewRepresentable {
    ...
    let paneId: UUID
    var surfaceIdentifier = "orlix.keyboardTest.terminalSurface"
...
final class TerminalKeyboardHarnessContainerView: UIView {
    ...
    private let gestureSurface: UIView = {
        ...
        view.accessibilityIdentifier = "orlix.keyboardTest.gestureSurface"
    ...
    override init(frame: CGRect) {
        ...
        accessibilityIdentifier = "orlix.keyboardTest.containerView"
    }
