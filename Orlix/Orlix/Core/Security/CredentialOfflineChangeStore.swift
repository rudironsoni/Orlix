...
nonisolated final class CredentialOfflineChangeStore: @unchecked Sendable {
    ...
    private static let reconciliationStateKey = "orlix.keychain.offlineReconciliation.v3"
    private static let stateKey = "orlix.keychain.offlineChanges.v1"
    private static let trackingKey = "orlix.keychain.offlineTracking.v1"
    private static let phaseKey = "orlix.keychain.offlineReconciliationPhase.v2"
    private static let changeDatesKey = "orlix.keychain.offlineChangeDates.v2"
    ...
    private func offlineWritePlanKey(service: String) -> String {
        "orlix.keychain.offlineWrite.\(service).v1"
    }
...
nonisolated final class CredentialOfflineWriteTransaction: @unchecked Sendable {
    private static let stagingPrefix = "orlix.offline-write-stage."
