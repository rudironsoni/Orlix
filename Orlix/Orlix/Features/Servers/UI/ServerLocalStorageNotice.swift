    ...
    var body: some View {
        if stateStore.ambiguousCloudRecovery != nil || !stateStore.localStorageIssues.isEmpty {
                ...
                if stateStore.ambiguousCloudRecovery != nil {
                    ...
                    NoticeBannerView(
                        item: NoticeItem(
                            ...
                            message: String(localized: "Orlix preserved a backup before using replacement data."),
            ...
            .confirmationDialog(
                ...
                Text(
                    String(
                        localized: "Orlix could not confirm that missing local items were intentionally removed."
                    )
                )
            }
            .alert(
