    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Help Improve Orlix shares anonymous statistics about which features are used — never what you type, your servers, or anything that identifies you.")
            }

            Section {
                Toggle(
                    String(
                        format: String(localized: "Require %@ to open Orlix"),
