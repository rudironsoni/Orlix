...
struct SyncSettingsView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("Credentials remain on this device. If you enable sync again, Orlix will store them in iCloud Keychain again.")
        }
    }
    ...
    private var syncToggleSection: some View {
        Section {
            Toggle("Sync with iCloud", isOn: $syncEnabled)
                .accessibilityIdentifier("orlix.settings.sync.toggle")
        }
    }
    ...
    private func troubleshootingSection(message: String) -> some View {
        Section {
            Label(message, systemImage: "exclamationmark.triangle")
                ...
                .accessibilityIdentifier("orlix.settings.sync.troubleshooting")
        }
    }
    ...
    private var credentialFailureText: String? {
        ...
        case .removal:
            String(
                localized: "Orlix could not remove every item. Your local copies remain safe. Try again."
            )
        case nil:
            nil
        }
