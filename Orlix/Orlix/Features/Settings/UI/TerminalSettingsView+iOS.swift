    ...
    var body: some View {
        Section {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Keeping the terminal size prevents keyboard-driven window resizes in remote apps such as tmux. Orlix moves the terminal to keep the cursor visible instead.")
            }
            .font(.caption)
