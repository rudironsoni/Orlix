...
struct StorageDetailsSheet: View {
    ...
    var body: some View {
        StorageDetailsPlatformShell(
            ...
            .accessibilityIdentifier("orlix.stats.storage.details")
    ...
    private var volumeList: some View {
        ...
        .accessibilityIdentifier("orlix.stats.storage.volumeList")
    }
    ...
    private var toolbarControl: some View {
        ...
        .accessibilityIdentifier("orlix.stats.storage.editMode")
    }
    ...
    private var bulkActionRows: some View {
        if hiddenVolumeCount > hiddenContainerVolumes.count {
            ...
            .accessibilityIdentifier("orlix.stats.storage.showAll")
        }
        ...
        if !visibleContainerVolumes.isEmpty {
            ...
            .accessibilityIdentifier("orlix.stats.storage.hideContainers")
        }
        ...
        if !hiddenContainerVolumes.isEmpty {
            ...
            .accessibilityIdentifier("orlix.stats.storage.showContainers")
        }
    }
