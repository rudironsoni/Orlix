...
struct ProUpgradeSheet: View {
    ...
    private var sheetContent: some View {
        ...
        .manageSubscriptionsSheetCompat(
            ...
            subscriptionGroupID: OrlixProducts.subscriptionGroupId
        )
        #endif
    }
    ...
    private var footerSupportRow: some View {
        HStack(spacing: 6) {
            ...
            legalLink(title: "Terms", url: "https://www.apple.com/legal/internet-services/itunes/dev/stdeula/")
        }
        .font(.caption)
        .foregroundStyle(.secondary)
        .lineLimit(1)
    ...
    private func handlePurchaseStateChange(_ newState: PurchaseState) {
        ...
        case .purchased:
            ...
            if storeManager.lastPurchasedProductId == OrlixProducts.proLifetime,
...
extension PaywallSource {
    var paywallTitle: String {
        ...
        case .welcome:
            return String(localized: "Orlix Pro")
        case .dockerStats:
...
private struct ComparisonTable: View {
    ...
    var body: some View {
        ...
        .accessibilityIdentifier("orlix.pro.comparison")
        .overlay {
