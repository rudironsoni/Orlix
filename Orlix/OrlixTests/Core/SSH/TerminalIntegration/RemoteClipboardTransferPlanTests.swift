...
struct RemoteClipboardTransferPlanTests {
    ...
    func convertsNativeWindowsDrivePathForOpenSSHSFTP() throws {
        ...
        #expect(
            try plan.transferPath(for: #"C:\Users\Wiedy Mi\AppData\Local\Temp\orlix-clipboard-a1.png"#)
                == "/C:/Users/Wiedy Mi/AppData/Local/Temp/orlix-clipboard-a1.png"
        )
    }
    ...
    func parsesOnlyAbsoluteTemporaryPathsForEachPlatform() throws {
        ...
        #expect(try posix.parseTemporaryPath("/tmp/orlix-clipboard-a1.png\n") == "/tmp/orlix-clipboard-a1.png")
        #expect(
            try windows.parseTemporaryPath(#"C:\Users\Wiedy Mi\AppData\Local\Temp\orlix-clipboard-a1.png"#)
                == #"C:\Users\Wiedy Mi\AppData\Local\Temp\orlix-clipboard-a1.png"#
        )
        #expect(throws: TerminalRichPasteError.self) {
            _ = try windows.parseTemporaryPath("orlix-clipboard-a1.png")
        }
    }
    ...
    func buildsExactWindowsCleanupAndOwnedStaleSweepCommands() throws {
        let plan = try RemoteClipboardTransferPlan.resolve(for: powerShellEnvironment)
        let path = #"C:\Users\O'Hara\AppData\Local\Temp\orlix-clipboard-a1.png"#
        ...
        #expect(
            decodePowerShellCommand(deleteCommand)
                == #"[IO.File]::Delete('C:\Users\O''Hara\AppData\Local\Temp\orlix-clipboard-a1.png')"#
        )
        ...
        #expect(decodedSweep.contains("orlix-clipboard-*"))
