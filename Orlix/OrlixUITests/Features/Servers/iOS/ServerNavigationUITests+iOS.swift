...
final class ServerNavigationUITests: XCTestCase {
    ...
    func testActiveTerminalPushPopPreservesListPositionAndSession() throws {
        ...
        let serverRow = app.descendants(matching: .any)
            .matching(
                identifier: "orlix.serverList.server.D3A03FD5-453E-43AC-8BB5-838E5D5D1990"
            )
            .firstMatch
        let activeRow = app.descendants(matching: .any)
            .matching(
                identifier: "orlix.serverList.activeConnection.D3A03FD5-453E-43AC-8BB5-838E5D5D1990"
            )
            .firstMatch
        let list = app.descendants(matching: .any)
            .matching(identifier: "orlix.serverList.list")
            .firstMatch
        ...
        let hideKeyboard = app.buttons["orlix.keyboard.accessory.hide"]
    ...
    private func assertPostMountServerMetadataReload(
        ...
        let toggle = app.buttons["orlix.navigationTest.toggleServerMetadata"]
    ...
    private func popTerminal(in app: XCUIApplication) {
        let back = app.buttons["orlix.terminal.back"]
    ...
    private func productionTerminal(in app: XCUIApplication) -> XCUIElement {
        app.descendants(matching: .any)
            .matching(identifier: "orlix.reconnectTest.terminalSurface")
            .firstMatch
    }
    ...
    private func diagnosticText(in app: XCUIApplication) -> String {
        app.staticTexts["orlix.reconnectTest.diagnostics"].label
    }
}
#endif
