...
final class TerminalHardwareRepeatUITests: TerminalKeyboardUITestCase {
    ...
    func testPrintableHardwareKeyRepeatOwnsResolvedTextUntilReleaseOrCancel() throws {
        ...
        app.buttons["orlix.keyboardTest.hardwareRepeat.begin.h"].tap()
        ...
        app.buttons["orlix.keyboardTest.hardwareRepeat.tick"].tap()
        app.buttons["orlix.keyboardTest.hardwareRepeat.tick"].tap()
        waitForHardwareRepeat(
            phase: "repeating",
            lowercaseHInputs: 3,
        ...
        app.buttons["orlix.keyboardTest.hardwareRepeat.release"].tap()
        wait(
            for: diagnostics,
        ...
        app.buttons["orlix.keyboardTest.hardwareRepeat.begin.shiftH"].tap()
        waitForHardwareRepeat(
            phase: "repeating",
            lowercaseHInputs: 3,
            uppercaseHInputs: 1,
        ...
        app.buttons["orlix.keyboardTest.hardwareRepeat.cancel"].tap()
        wait(
            for: diagnostics,
            labelContaining: "hardwareRepeatPhase=idle",
            timeout: 5,
