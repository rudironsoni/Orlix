...
final class TerminalKeyboardGeometryUITests: TerminalKeyboardUITestCase {
    ...
    func testDockedFloatingDockedGeometryKeepsSurfaceAndViewportValid() throws {
        ...
        for identifier in [
            "orlix.keyboardTest.geometry.docked",
            "orlix.keyboardTest.geometry.floating",
            "orlix.keyboardTest.geometry.docked",
            "orlix.keyboardTest.geometry.floating",
            "orlix.keyboardTest.geometry.docked",
        ] {
        ...
        let hiddenButton = app.buttons["orlix.keyboardTest.geometry.hidden"]
    ...
    func testDefaultLayoutClearsDockedInsetForEveryFloatingTransition() throws {
        ...
        app.buttons["orlix.keyboardTest.geometry.hidden"].tap()
        wait(
            for: diagnostics,
