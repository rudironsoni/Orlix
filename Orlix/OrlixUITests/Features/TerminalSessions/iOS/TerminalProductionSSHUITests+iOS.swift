...
final class TerminalProductionSSHUITests: TerminalReconnectUITestCase {
    ...
    func testProductionSSHBackgroundPreservesSessionKeyboardAndTyping() throws {
        ...
        for connectionNumber in 2...4 {
            ...
            XCTAssertTrue(
                ...
                "Orlix did not enter the background. \(diagnosticText(in: app))"
            )
            ...
            XCTAssertTrue(
                ...
                "Orlix did not return to the foreground. \(diagnosticText(in: app))"
            )
            wait(
                for: diagnostics,
                containing: "setup=ready state=connected",
    ...
    func testProductionCodexFindKeyboardMenuRestoresPTYTyping() throws {
        ...
        let lossControl = app.buttons["orlix.reconnectTest.keyboard.unexpectedLoss"]
        ...
        let staleFrameControl = app.buttons["orlix.reconnectTest.keyboard.staleFindFrame"]
