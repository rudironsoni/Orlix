...
final class TerminalScreenAwakeUITests: XCTestCase {
    ...
    func testTerminalSettingControlsIdleTimerAndRestoresAfterBackground() {
        ...
        app.launchArguments = [
            "--orlix-ui-test-terminal-screen-awake-harness",
            "-AppleLanguages", "(en)",
            "-AppleLocale", "en_US",
            "-hasSeenWelcome", "YES",
        ...
        let diagnostics = app.staticTexts["orlix.screenAwakeTest.diagnostics"]
    ...
    private func keepScreenAwakeToggle(
        ...
        let toggle = app.descendants(matching: .any)
            .matching(identifier: "orlix.settings.terminal.keepScreenAwake")
            .firstMatch
