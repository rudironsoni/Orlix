...
__kunit: __prepare-kbuild
	...
	for object in arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/switch_debug.o arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/native_capture.o arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_native_observation_test.o arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_memory_tagging_source_bound_test.o arch/$(ORLIX_PORT_ARCH)/mm/mte.o arch/$(ORLIX_PORT_ARCH)/mm/copypage.o arch/$(ORLIX_PORT_ARCH)/mm/orlix_tcti_user_page.o; do \
...
__kernel-archive: __prepare-kbuild
	...
	compile_slice() { \
		...
		mkdir -p "$$obj_dir"; \
		$(orlix_object_dependency_predicate) \
		...
		if [ "$$object_set_ready" -eq 1 ]; then \
			...
			if [ -s "$$obj" ] && \
				...
				orlix_object_dependencies_current "$$obj" "$$dep"; then \
				needs_build=0; \
			fi; \
