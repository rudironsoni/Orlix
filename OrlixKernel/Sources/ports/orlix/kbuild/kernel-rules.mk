...
build:
	@$(MAKE) -f OrlixKernel/Makefile clean PROFILE="$(PROFILE)"
	@$(MAKE) -f OrlixKernel/Makefile __ios-simulator-xcframework PROFILE="$(PROFILE)"
...
__kernel-payload: __prepare-kbuild $(ORLIX_KERNEL_PAYLOAD_PREREQS)
	@set -euo pipefail; \
