...
ORLIX_IOS_TARGET := arm64-apple-ios15.0
ORLIX_IOS_SIMULATOR_TARGET := arm64-apple-ios15.0-simulator
ORLIX_HOSTED_SYSCALL_GATE_ADDRESS ?= 0x00000001fff00000
...
ORLIX_KERNEL_LINUX_SOURCES += \
	...
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_base_exceptions_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_base_conditional_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_base_bitfield_unary_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_base_multiply_divide_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_crypto_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_permute_move_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_integer_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_fp_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_scalar_fp_source_bound_test.c \
	...
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_mul_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_integer_min_max_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_integer_minmax_reduction_source_bound_test.c \
	...
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_permute_source_bound_test.c \
	arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/tests/orlix_tcti_advsimd_table_lookup_source_bound_test.c \
...
ORLIX_KERNEL_KBUILD_CC := $(if $(strip $(ORLIX_COMPILER_LAUNCHER)),$(strip $(ORLIX_COMPILER_LAUNCHER)) $(ORLIX_KERNEL_CC),$(ORLIX_KERNEL_CC))
ORLIX_KERNEL_KBUILD_HOSTCC := $(if $(strip $(ORLIX_COMPILER_LAUNCHER)),$(strip $(ORLIX_COMPILER_LAUNCHER)) $(ORLIX_KERNEL_HOSTCC),$(ORLIX_KERNEL_HOSTCC))
ORLIX_KERNEL_HOST_SDKROOT ?= $(shell xcrun --sdk macosx --show-sdk-path 2>/dev/null)
ORLIX_KERNEL_AR ?= llvm-ar
ORLIX_KERNEL_KBUILD_BUILD_VERSION ?= 1
...
__candidate-source-revision-tests:
	...
	publisher_actual="$$tmp/publisher-actual"; publisher_expected="$$tmp/publisher-expected"; \
	...
	contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_source" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs" || fail 'valid publisher whitespace or comments changed contract ownership'; \
	publisher_live="$$tmp/publisher-live"; $(MAKE) --no-print-directory --silent -f OrlixKernel/Makefile __orlix-tcti-target-refresh-publisher-list-source-check ORLIX_TCTI_TARGET_REFRESH_ARTIFACTS_DECLARATION="$$publisher_copy" > "$$publisher_live"; cmp -s "$$publisher_actual" "$$publisher_live" || fail 'live publisher list diverges from shared X-macro grammar'; \
	printf 'ORLIX_TCTI_TARGET_REFRESH_ARTIFACT(bad, bad.def, manifest) trailing\n' > "$$publisher_copy"; if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_source" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'malformed publisher row was accepted'; fi; \
	cp "$$publisher_declaration" "$$publisher_copy"; printf 'ORLIX_TCTI_TARGET_REFRESH_ARTIFACT(future,future.def,manifest)\n' >> "$$publisher_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_source" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'publisher addition absent from canonical/direct ownership was accepted'; fi; \
	cp "$$publisher_declaration" "$$publisher_copy"; head -n 3 "$$publisher_declaration" | tail -n 1 >> "$$publisher_copy"; if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_source" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'duplicate publisher row was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '\n$$(obj)/future.o: $$(src)/../isa/future.def\n' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'direct Kbuild addition absent from canonical declaration was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '\nfuture_isa_root=isa\n$$(obj)/future-variable.o: $$(src)/../$$(future_isa_root)/future-variable.def\n' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'direct Kbuild variable path addition was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '\nfuture_isa_root=isa\n$$(obj)/future-braced-variable.o: $$(src)/../$${future_isa_root}/future-braced-variable.def\n' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'direct Kbuild braced variable path addition was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '\n$$(obj)/future-outside.o: /outside/generated/isa/future-outside.def\n' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'direct Kbuild outside-root path addition was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '\n$$(obj)/future-shell.o: $$(shell printf %%s "$$(src)/../isa/inventory.def")\n' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'dynamic shell direct Kbuild path was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '%s%s\n' '$$(obj)/future-continuation.o: ' "\\" >> "$$kbuild_copy"; printf '%s\n' '  $$(shell printf %%s "$$(src)/../isa/inventory.def")' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'dynamic shell continuation direct Kbuild path was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '\n$$(obj)/future-braced-shell.o: $${shell printf %%s "$${src}/../isa/inventory.def"}\n' >> "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'braced dynamic shell direct Kbuild path was accepted'; fi; \
	cp "$$kbuild_source" "$$kbuild_copy"; printf '%s\n' '# $$(obj)/future-comment.o: $$(shell printf %%s "$$(src)/../isa/inventory.def")' >> "$$kbuild_copy"; \
	if ! contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'commented direct Kbuild path was rejected'; fi; \
	fixture_root="$$tmp/symlink-fixture"; fixture_tests="$$fixture_root/tests"; fixture_isa="$$fixture_root/isa"; mkdir -p "$$fixture_tests" "$$fixture_isa/generations/current" "$$tmp/outside"; printf 'outside\n' > "$$tmp/outside/escape.def"; cp "$$kbuild_source" "$$fixture_tests/Makefile"; cp "$$publisher_declaration" "$$fixture_root/target_refresh_artifacts.def"; fixture_inputs=(); for contributor in "$${canonical_inputs[@]}"; do contributor_rel="$${contributor##*/isa/}"; fixture_path="$$fixture_isa/$$contributor_rel"; mkdir -p "$${fixture_path%/*}"; cp "$$contributor" "$$fixture_path"; fixture_inputs+=("$$fixture_path"); done; mkdir -p "$$fixture_isa/escape"; ln -s "$$tmp/outside" "$$fixture_isa/escape/outside"; cp "$$kbuild_source" "$$kbuild_copy"; printf '\n$$(obj)/future-symlink.o: $$(src)/../isa/escape/outside/escape.def\n' >> "$$kbuild_copy"; if ORLIX_TCTI_CONTRACT_FIXTURE_ROOT="$$fixture_tests" contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$fixture_root/target_refresh_artifacts.def" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$${fixture_inputs[*]}"; then fail 'symlink escape direct Kbuild path was accepted'; fi; \
	awk 'BEGIN { skip_next = 0 } skip_next { skip_next = 0; next } index($$0, "target_proof_registry.o:") && index($$0, "ORLIX_TCTI_PROOF_REGISTRY_ARTIFACT_INPUTS") { printf "%c(obj)/target_proof_registry.o: %c(obj)/target_proof_registry_provenance.h\n", 36, 36; skip_next = 1; next } { print }' "$$kbuild_source" > "$$kbuild_copy"; \
	if contract_check ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_PUBLISHER_DECLARATION="$$publisher_declaration" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_KBUILD_DECLARATION="$$kbuild_copy" ORLIX_TCTI_INSTRUCTION_ARTIFACT_CONTRACT_INPUTS="$$contract_inputs"; then fail 'removed effective direct Kbuild prerequisite was accepted'; fi; \
...
__kunit: __prepare-kbuild
	...
	kunit_config="$(ORLIX_KUNIT_BUILD_DIR)/.config"; \
	kunit_fragment="$(ORLIX_KERNEL_PORT_ABS)/arch/$(ORLIX_PORT_ARCH)/.kunitconfig"; \
	if [ ! -s "$$kunit_config" ] || [ "$(ORLIX_PROFILE_CONFIG)" -nt "$$kunit_config" ] || [ "$(ORLIX_KERNEL_PORT_DIR)/.orlix-port-profile" -nt "$$kunit_config" ] || [ "$$kunit_fragment" -nt "$$kunit_config" ]; then \
		...
		"$(ORLIX_KERNEL_PORT_ABS)/scripts/kconfig/merge_config.sh" -m -O "$(ORLIX_KUNIT_BUILD_DIR)" "$$kunit_config" "$$kunit_fragment"; \
	else \
...
__kernel-archive: __prepare-kbuild
	...
	if [ -n "$$launcher" ]; then command -v "$$launcher" >/dev/null 2>&1 || { echo "compiler launcher is not executable: $$launcher" >&2; exit 1; }; fi; \
	...
	target_inventory_system_accessors="$(ORLIX_KERNEL_PORT_ABS)/arch/$(ORLIX_PORT_ARCH)/hosted_exec/orlix_tcti/isa/target_system_accessor_reconciliation.def"; \
		...
		if [ "$(ORLIX_KERNEL_KUNIT)" = 1 ]; then \
			...
			/usr/bin/env -u IPHONEOS_DEPLOYMENT_TARGET \
				...
				"$$inventory_generator" -o "$$inventory_tool"; \
		fi; \
	...
	build_version="$(ORLIX_KERNEL_KBUILD_BUILD_VERSION)"; \
	build_timestamp="$(ORLIX_KERNEL_KBUILD_BUILD_TIMESTAMP)"; \
	smp_flag=""; \
	preempt_flag=""; \
	...
	uts_header="$(ORLIX_KERNEL_BUILD_DIR)/init/utsversion-tmp.h"; \
	printf '#define UTS_VERSION "%s"\n' "$$uts_version" > "$$uts_header.new"; \
	if ! cmp -s "$$uts_header.new" "$$uts_header"; then mv "$$uts_header.new" "$$uts_header"; else unlink "$$uts_header.new"; fi; \
