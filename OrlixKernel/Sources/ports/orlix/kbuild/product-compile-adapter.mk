...
ORLIX_PRODUCT_ADAPTER_CFLAGS := -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -fshort-wchar -DPER_CPU_BASE_SECTION=\"__DATA,__percpu\" -DORLIX_HOSTED_SYSCALL_GATE_ADDRESS=$(ORLIX_HOSTED_SYSCALL_GATE_ADDRESS) -I"$(ORLIX_PRODUCT_ADAPTER_INCLUDE)"
