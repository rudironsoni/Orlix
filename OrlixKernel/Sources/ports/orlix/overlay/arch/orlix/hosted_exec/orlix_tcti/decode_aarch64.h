...
/* The decoder must carry the exact feature identity to the admission gate.
 * Zero is intentionally untrusted, so a hand-built or incomplete decoded
 * value cannot enter the guest as a baseline instruction. */
