...
#define ORLIX_TCTI_TARGET_REFRESH_GENERATOR "orlix-tcti-target-refresh-system-accessor-v3"
#ifndef ORLIX_TCTI_TARGET_REFRESH_PRODUCER_SHA256
#error "Make must provide ORLIX_TCTI_TARGET_REFRESH_PRODUCER_SHA256"
#endif
