...
#ifndef ORLIX_TCTI_ADVSIMD_INTEGER_PRODUCTION_CAPTURE_H
#define ORLIX_TCTI_ADVSIMD_INTEGER_PRODUCTION_CAPTURE_H

#include "target_native_proof_registry_private.h"
#include "target_proof_registry.h"

static inline const void *
orlix_tcti_advsimd_integer_production_capture_token(u32 source_ordinal,
						    u32 obligation)
{
