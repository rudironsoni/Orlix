...
#ifndef ORLIX_TCTI_BASE_ADD_SUB_PRODUCTION_CAPTURE_H
#define ORLIX_TCTI_BASE_ADD_SUB_PRODUCTION_CAPTURE_H

#include "target_native_proof_registry_private.h"
#include "target_proof_registry.h"

static inline const void *
orlix_tcti_base_add_sub_production_capture_token(u32 source_ordinal,
						 u32 obligation)
{
