...
static struct kunit_case orlix_tcti_native_capture_test_cases[] = {
	KUNIT_CASE(capture_requires_a_registry_issued_token),
	KUNIT_CASE(private_wire_view_cannot_mint_a_pending_capability),
	{}
};

static struct kunit_suite orlix_tcti_native_capture_test_suite = {
	.name = "orlix-tcti-native-capture",
	.test_cases = orlix_tcti_native_capture_test_cases,
};
kunit_test_suite(orlix_tcti_native_capture_test_suite);
MODULE_LICENSE("GPL");
