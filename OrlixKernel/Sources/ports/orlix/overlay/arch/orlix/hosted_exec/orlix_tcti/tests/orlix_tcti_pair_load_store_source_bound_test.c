...
static const struct plsp_expectation plsp_expected[] = {
	PLSP(2856, false, false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2857, true,  false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2858, false, true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2859, true,  true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2860, false, true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2861, true,  true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2862, false, false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2863, true,  false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2864, false, true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2865, true,  true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2870, false, false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2871, true,  false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2872, false, true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2873, true,  true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2875, true,  false, 4, 8, true,  ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2876, false, true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2877, true,  true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2878, false, false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2879, true,  false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2880, false, true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2881, true,  true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_POST),
	PLSP(2886, false, false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2887, true,  false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2888, false, true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2889, true,  true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2891, true,  false, 4, 8, true,  ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2892, false, true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2893, true,  true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2894, false, false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2895, true,  false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2896, false, true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2897, true,  true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET),
	PLSP(2902, false, false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2903, true,  false, 4, 4, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2904, false, true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2905, true,  true,  4, 4, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2907, true,  false, 4, 8, true,  ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2908, false, true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2909, true,  true,  8, 8, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2910, false, false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2911, true,  false, 8, 8, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2912, false, true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
	PLSP(2913, true,  true, 16,16, false, ORLIX_TCTI_MEMORY_INDEX_PRE),
};
#undef PLSP
...
static struct orlix_tcti_result plsp_run(struct kunit *test, u32 instruction,
					   struct pt_regs *regs)
{
...
{
	return decoded->memory_index_mode == ORLIX_TCTI_MEMORY_INDEX_POST ? base :
			    ...
			    u8 size, const u64 values[4])
{
	...
	ret = orlix_tcti_write_user_data(current->mm, address, values, size);
	KUNIT_ASSERT_EQ(test, 0, ret);
	ret = orlix_tcti_write_user_data(current->mm, address + size,
				  values + 2, size);
	KUNIT_ASSERT_EQ(test, 0, ret);
}
			     ...
			     u8 size, const u64 values[4])
{
	...
	ret = orlix_tcti_read_user_data(current->mm, address, observed, size);
	KUNIT_ASSERT_EQ(test, 0, ret);
	KUNIT_EXPECT_EQ(test, size == sizeof(u32) ? (u64)(u32)values[0] :
			values[0], observed[0]);
	if (size == 2 * sizeof(u64))
		KUNIT_EXPECT_EQ(test, values[1], observed[1]);
	ret = orlix_tcti_read_user_data(current->mm, address + size, observed, size);
	KUNIT_ASSERT_EQ(test, 0, ret);
...
static void plsp_every_source_leaf_executes_through_resume(struct kunit *test)
{
	...
	for (index = 0; index < ARRAY_SIZE(plsp_expected); index++) {
		...
		KUNIT_ASSERT_EQ_MSG(test, ORLIX_TCTI_DECODE_LOAD_STORE_PAIR,
		...
		if (expected->index_mode != ORLIX_TCTI_MEMORY_INDEX_SIGNED_OFFSET)
...
static void plsp_second_transfer_faults_preserve_register_state(struct kunit *test)
{
	...
	KUNIT_ASSERT_EQ(test, 0, ret);
	ret = orlix_tcti_write_user_data(current->mm, data + PAGE_SIZE - sizeof(u64),
	...
	KUNIT_EXPECT_EQ(test, fpcr_before, current->thread.user_fpcr);
	KUNIT_EXPECT_EQ(test, fpsr_before, current->thread.user_fpsr);
	ret = orlix_tcti_read_user_data(current->mm, data + PAGE_SIZE - sizeof(u64),
...
static struct kunit_suite orlix_tcti_pair_load_store_source_bound_suite = {
...
kunit_test_suite(orlix_tcti_pair_load_store_source_bound_suite);
