...
#define ORLIX_TCTI_A64_SYSTEM_ACCESSOR(accessor, encoding, name_value, variant, \
		...
		selector_identity_value, condition_identity_value, access_identity, decode_key, operation, \
	...
	{ accessor, encoding, name_value, variant, generic, direction_value, \
	  ...
	  condition_identity_value, access_identity, decode_key, operation, decoder, executor, suite, \
