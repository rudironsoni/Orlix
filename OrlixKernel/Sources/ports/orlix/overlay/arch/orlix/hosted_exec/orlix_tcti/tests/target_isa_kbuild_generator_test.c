...
#define ORLIX_TCTI_A64_KBUILD_GENERATOR_NO_BUILTIN_INPUT
...
struct fixture {
	struct orlix_tcti_a64_kbuild_metadata metadata;
	struct orlix_tcti_a64_kbuild_source_row *source;
	struct orlix_tcti_a64_kbuild_classification_row *classification;
	struct orlix_tcti_a64_kbuild_system_accessor_metadata accessor_metadata;
	struct orlix_tcti_a64_kbuild_system_accessor_row *accessors;
	char (*names)[24];
...
static int fixture_init(struct fixture *fixture)
{
	...
	fixture->metadata = (struct orlix_tcti_a64_kbuild_metadata){
		.architecture = ORLIX_TCTI_A64_KBUILD_ARCHITECTURE,
		.build = ORLIX_TCTI_A64_KBUILD_BUILD,
		.reference = ORLIX_TCTI_A64_KBUILD_REFERENCE,
		.schema = ORLIX_TCTI_A64_KBUILD_SCHEMA,
		.instructions_sha256 =
			ORLIX_TCTI_A64_KBUILD_INSTRUCTIONS_SHA256,
		.timestamp = ORLIX_TCTI_A64_KBUILD_INSTRUCTIONS_TIMESTAMP,
		.source_byte_length =
			ORLIX_TCTI_A64_KBUILD_INSTRUCTIONS_SOURCE_BYTES,
		.source_count = ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
	};
	fixture->source = calloc(ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
				 sizeof(*fixture->source));
	fixture->classification =
		calloc(ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		       sizeof(*fixture->classification));
	fixture->names = calloc(ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
			       sizeof(*fixture->names));
	fixture->accessors = calloc(ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT,
				   sizeof(*fixture->accessors));
	fixture->accessor_names =
		calloc(ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT,
	...
	for (index = 0; index < ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT; index++) {
		...
		fixture->classification[index] =
			(struct orlix_tcti_a64_kbuild_classification_row){
				...
				.relation = ORLIX_TCTI_A64_KBUILD_RELATION_NONE,
				.canonical = "",
				.evidence = "",
				.proof = "",
			};
	...
	fixture->accessor_metadata =
		(struct orlix_tcti_a64_kbuild_system_accessor_metadata){
			...
			.reference = ORLIX_TCTI_A64_KBUILD_REFERENCE,
			.schema = ORLIX_TCTI_A64_KBUILD_SCHEMA,
			.timestamp = ORLIX_TCTI_A64_KBUILD_REGISTERS_TIMESTAMP,
	...
	fixture->accessor_metadata.reconciliation_identity =
		orlix_tcti_a64_kbuild_system_accessor_identity(
			fixture->accessors, ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT);
	return 0;
}
...
static int emitted_string_offsets_resolve_exact_source_strings(void)
{
	...
	for (index = 0; index < ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT;
	     index++) {
		CHECK(!emitted_string_equals(pool, pool_size,
...
static int expect_failure(struct fixture *fixture,
			  enum orlix_tcti_a64_kbuild_generator_error expected)
{
	FILE *output = tmpfile();
	...
	CHECK(orlix_tcti_a64_kbuild_generate_header(
		      ...
		      ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		      &fixture->accessor_metadata, fixture->accessors,
		      ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT, output) == expected);
...
static int deterministic_fixed_width_artifact(void)
{
	...
	CHECK(orlix_tcti_a64_kbuild_generate_header(
		      ...
		      ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		      &fixture.accessor_metadata, fixture.accessors,
		      ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT, first) ==
	      ORLIX_TCTI_A64_KBUILD_GENERATOR_OK);
	CHECK(orlix_tcti_a64_kbuild_generate_header(
		      &fixture.metadata, fixture.source,
		      ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT, fixture.classification,
		      ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		      &fixture.accessor_metadata, fixture.accessors,
		      ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT, second) ==
	      ORLIX_TCTI_A64_KBUILD_GENERATOR_OK);
	CHECK(!streams_equal(first, second));
	CHECK(!stream_contains(first,
		"#define ORLIX_TCTI_A64_GENERATED_SOURCE_COUNT 4350U"));
	CHECK(!stream_contains(first,
		"#define ORLIX_TCTI_A64_GENERATED_UNCLASSIFIED_COUNT 1U"));
	CHECK(!stream_contains(first,
		"#define ORLIX_TCTI_A64_GENERATED_CLASSIFICATION_COMPLETE 0U"));
	CHECK(!stream_contains(first,
...
static int adversarial_c_fixtures(void)
{
	...
	enum orlix_tcti_a64_kbuild_relation saved_relation;
	enum orlix_tcti_a64_kbuild_system_accessor_disposition saved_disposition;
	...
	CHECK(orlix_tcti_a64_kbuild_generate_header(
		      &fixture.metadata, fixture.source,
		      ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT - 1U,
		      fixture.classification, ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		      &fixture.accessor_metadata, fixture.accessors,
		      ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT,
		      output) == ORLIX_TCTI_A64_KBUILD_GENERATOR_COUNT_MISMATCH);
	CHECK(stream_length(output) == 0);
	fclose(output);
	...
	CHECK(orlix_tcti_a64_kbuild_generate_header(
		      ...
		      ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		      &fixture.accessor_metadata, fixture.accessors,
		      ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT - 1U,
		      output) ==
	...
	CHECK(!expect_failure(&fixture,
		ORLIX_TCTI_A64_KBUILD_GENERATOR_METADATA_MISMATCH));
	fixture.metadata.timestamp = ORLIX_TCTI_A64_KBUILD_INSTRUCTIONS_TIMESTAMP;

	saved_ordinal = fixture.source[17].ordinal;
	fixture.source[17].ordinal = 16U;
	CHECK(!expect_failure(&fixture, ORLIX_TCTI_A64_KBUILD_GENERATOR_BAD_ORDINAL));
	...
	CHECK(!expect_failure(
		&fixture, ORLIX_TCTI_A64_KBUILD_GENERATOR_CLASSIFICATION_MISMATCH));
	...
	fixture.classification[1].classification =
		(enum orlix_tcti_a64_kbuild_classification)99;
	CHECK(!expect_failure(&fixture,
	...
	fixture.classification[2].relation = ORLIX_TCTI_A64_KBUILD_RELATION_ALIAS;
	...
	CHECK(output != NULL);
	CHECK(orlix_tcti_a64_kbuild_generate_header(
		&fixture.metadata, fixture.source, ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		fixture.classification, ORLIX_TCTI_A64_KBUILD_SOURCE_COUNT,
		&fixture.accessor_metadata, fixture.accessors,
		ORLIX_TCTI_A64_KBUILD_SYSTEM_ACCESSOR_COUNT, output) ==
		ORLIX_TCTI_A64_KBUILD_GENERATOR_OK);
	...
	CHECK(!expect_failure(&fixture,
		ORLIX_TCTI_A64_KBUILD_GENERATOR_BAD_CLASSIFICATION));
	fixture.classification[1].classification = ORLIX_TCTI_A64_KBUILD_REQUIRED;
	fixture.classification[1].relation = ORLIX_TCTI_A64_KBUILD_RELATION_NONE;
	...
	CHECK(!expect_failure(&fixture,
		ORLIX_TCTI_A64_KBUILD_GENERATOR_BAD_CLASSIFICATION));
	fixture.classification[2].classification = ORLIX_TCTI_A64_KBUILD_REQUIRED;
	fixture.classification[2].relation = ORLIX_TCTI_A64_KBUILD_RELATION_NONE;
	fixture.classification[2].canonical = "";
