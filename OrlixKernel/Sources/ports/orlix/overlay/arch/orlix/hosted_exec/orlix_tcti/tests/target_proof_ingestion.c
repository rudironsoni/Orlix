	...
	enum orlix_tcti_target_proof_ingestion_error *error)
{
	...
	else if (record->kind == ORLIX_TCTI_TARGET_NATIVE_RESULT_MEMORY)
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_MEMORY;
	else if (record->kind == ORLIX_TCTI_TARGET_NATIVE_RESULT_FP_SIMD)
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS;
	else if (record->kind == ORLIX_TCTI_TARGET_NATIVE_RESULT_FAULT)
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FAULTS;
	else if (record->kind == ORLIX_TCTI_TARGET_NATIVE_RESULT_ORDERING)
