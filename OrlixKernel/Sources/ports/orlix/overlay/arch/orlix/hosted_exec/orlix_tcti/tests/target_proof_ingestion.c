	...
	enum orlix_tcti_target_proof_ingestion_error *error)
{
	...
	case ORLIX_TCTI_TARGET_NATIVE_RESULT_MEMORY:
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_MEMORY;
		break;
	case ORLIX_TCTI_TARGET_NATIVE_RESULT_FP_SIMD:
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FP_SIMD;
		break;
	case ORLIX_TCTI_TARGET_NATIVE_RESULT_SVE:
	...
	case ORLIX_TCTI_TARGET_NATIVE_RESULT_FAULT:
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FAULTS;
		break;
	case ORLIX_TCTI_TARGET_NATIVE_RESULT_ATOMICITY:
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_ATOMICITY;
		break;
	case ORLIX_TCTI_TARGET_NATIVE_RESULT_ORDERING:
		obligation = ORLIX_TCTI_TARGET_PROOF_OBLIGATION_ORDERING;
		break;
	default:
