...
#define ADD_SUB_REGISTER_OBLIGATIONS \
	(BASELINE_OBLIGATIONS | ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS | \
	 ORLIX_TCTI_TARGET_PROOF_OBLIGATION_MEMORY | \
	 ORLIX_TCTI_TARGET_PROOF_OBLIGATION_PC | \
	 ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FLAGS)
#define ADD_SUB_POINTER_OBLIGATIONS \
	ADD_SUB_REGISTER_OBLIGATIONS
...
static const struct kunit_source_provenance kunit_sources[] = {
	...
	{ ADD_SUB_IMMEDIATE_SOURCE,
	  "7fc14871713831f69cbd849db58127191aa65027ef0fff7930fefe2aa67a37fe",
	...
	{ ADD_SUB_REGISTER_SOURCE,
	  "34db1818b4b8db4da524c1b2f04698de8c8a2b93af198589ab32ac89a2f0b458",
...
static const struct kunit_case_provenance kunit_case_provenance[] = {
	...
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_decode_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_legal_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_LEGAL_ENCODINGS },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_rejected_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REJECTED_ENCODINGS },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	...
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_pc_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_PC },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_flags_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FLAGS },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_memory_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_MEMORY },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	...
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_sve_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS },
	{ ADD_SUB_IMMEDIATE_SOURCE, ADD_SUB_IMMEDIATE_SUITE,
	  ADD_SUB_IMMEDIATE_SUITE_SYMBOL, ADD_SUB_IMMEDIATE_CASE_ARRAY,
	  "orlix_tcti_add_sub_immediate_native_sme_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS },
	...
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_issue_133_exact_cohort",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_pointer_source_and_decode",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE |
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_LEGAL_ENCODINGS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_pointer_production_semantics",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS |
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_PC |
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FLAGS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_pointer_rejections_are_structured",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE |
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REJECTED_ENCODINGS |
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS |
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_PC },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_decode_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_legal_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_LEGAL_ENCODINGS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_rejected_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REJECTED_ENCODINGS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_register_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_pc_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_PC },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_flags_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FLAGS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_memory_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_MEMORY },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_fp_simd_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_sve_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS },
	{ ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
	  ADD_SUB_REGISTER_SUITE_SYMBOL, ADD_SUB_REGISTER_CASE_ARRAY,
	  "asr_native_sme_records",
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS },
	{ SOURCE_LEAF_CLASSIFICATION_SOURCE,
...
#undef ORLIX_TCTI_PROOF_FAMILY_OPERATION
	{ "ADDPT", ADD_SUB_POINTER_OBLIGATIONS },
	{ "SUBPT", ADD_SUB_POINTER_OBLIGATIONS },
...
#define SCALAR_REQUIREMENT(operation, obligations) { operation, obligations }
	...
	SCALAR_REQUIREMENT("ADD_addsub_shift", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("ADDS_addsub_shift", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("SUB_addsub_shift", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("SUBS_addsub_shift", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("ADD_addsub_ext", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("ADDS_addsub_ext", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("SUB_addsub_ext", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("SUBS_addsub_ext", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("ADC", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("ADCS", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("SBC", ADD_SUB_REGISTER_OBLIGATIONS),
	SCALAR_REQUIREMENT("SBCS", ADD_SUB_REGISTER_OBLIGATIONS),
...
#define ADD_SUB_IMMEDIATE_NATIVE_CASES \
	{ "orlix_tcti_add_sub_immediate_native_decode_records", \
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE }, \
	{ "orlix_tcti_add_sub_immediate_native_legal_records", \
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_LEGAL_ENCODINGS }, \
...
#define ADD_SUB_IMMEDIATE_BASE_BINDING(ordinal, leaf, mnemonic, pattern) \
	{ leaf, mnemonic, 0xff800000U, pattern, ADD_SUB_IMMEDIATE_CONDITION, \
	  ORLIX_TCTI_PROOF_U64_C(0x3ff), ordinal }
...
#define ADD_SUB_REGISTER_NATIVE_CASES \
	{ "asr_native_decode_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_DECODE }, \
	{ "asr_native_legal_records", \
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_LEGAL_ENCODINGS }, \
	{ "asr_native_rejected_records", \
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REJECTED_ENCODINGS }, \
	{ "asr_native_register_records", \
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS }, \
	{ "asr_native_pc_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_PC }, \
	{ "asr_native_flags_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_FLAGS }, \
	{ "asr_native_memory_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_MEMORY }, \
	{ "asr_native_fp_simd_records", \
	  ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS }, \
	{ "asr_native_sve_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS }, \
	{ "asr_native_sme_records", ORLIX_TCTI_TARGET_PROOF_OBLIGATION_REGISTERS }

static const struct orlix_tcti_target_proof_case add_sub_register_base_cases[] = {
	ADD_SUB_REGISTER_NATIVE_CASES,
};
...
static const struct orlix_tcti_target_proof_case add_sub_pointer_cases[] = {
	ADD_SUB_REGISTER_NATIVE_CASES,
};
#undef ADD_SUB_REGISTER_NATIVE_CASES
...
#define SCALAR_CPA_OPERATION(operation, proof, minimum) \
	{ operation, proof, ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE, \
	  CPA_CONDITION, add_sub_pointer_cases, ARRAY_COUNT(add_sub_pointer_cases), \
...
static struct scalar_registry_operation scalar_registry_operations[] = {
	...
	SCALAR_OPERATION("SBCS", "kunit:add-sub-register-sbcs",
		ADD_SUB_REGISTER_SOURCE, ADD_SUB_REGISTER_SUITE,
		add_sub_register_flags_cases, 3466U, 3473U, 2),
	SCALAR_CPA_OPERATION("ADDPT", "kunit:add-sub-register-addpt", 3474U),
	SCALAR_CPA_OPERATION("SUBPT", "kunit:add-sub-register-subpt", 3475U),
