...
#define BASE_OBLIGATIONS \
	(TCTI_SCALAR_OBLIGATION_DECODE | \
	 TCTI_SCALAR_OBLIGATION_LEGAL_ENCODINGS | \
	 TCTI_SCALAR_OBLIGATION_REJECTED_ENCODINGS)
#define REG_PC (BASE_OBLIGATIONS | TCTI_SCALAR_OBLIGATION_REGISTERS | \
		TCTI_SCALAR_OBLIGATION_PC)
#define REG_PC_FLAGS (REG_PC | TCTI_SCALAR_OBLIGATION_FLAGS)
#define CONTROL_PC (REG_PC | TCTI_SCALAR_OBLIGATION_FLAGS)
#define EXCEPTION_EXIT \
	(BASE_OBLIGATIONS | TCTI_SCALAR_OBLIGATION_REGISTERS | \
	 TCTI_SCALAR_OBLIGATION_PC | TCTI_SCALAR_OBLIGATION_FAULTS | \
	 TCTI_SCALAR_OBLIGATION_STRUCTURED_EXIT)
#define BARRIER \
	(BASE_OBLIGATIONS | TCTI_SCALAR_OBLIGATION_PC | \
	 TCTI_SCALAR_OBLIGATION_ORDERING)
#define SYSTEM_STATE \
	(REG_PC | TCTI_SCALAR_OBLIGATION_SYSTEM_STATE)
...
#define DECODE_OBJECT "tcti_decode_test.o"
...
#define TCTI_SCALAR_CLASS_REQUIRED true
#define TCTI_SCALAR_CLASS_UNCLASSIFIED false
#define TCTI_SCALAR_CLASS_NON_EL0 false
#define TCTI_SCALAR_CLASS_ARCHITECTURALLY_UNDEFINED false
#define TCTI_SCALAR_STRINGIFY_INNER(value) #value
#define TCTI_SCALAR_STRINGIFY(value) TCTI_SCALAR_STRINGIFY_INNER(value)
#define TCTI_A64_TARGET_CLASSIFICATION(leaf, classification, relation, \
				       related_leaf, evidence, proof) \
	{ TCTI_SCALAR_STRINGIFY(leaf), \
	  TCTI_SCALAR_CLASS_##classification },
...
#undef TCTI_SCALAR_STRINGIFY
#undef TCTI_SCALAR_STRINGIFY_INNER
#undef TCTI_SCALAR_CLASS_ARCHITECTURALLY_UNDEFINED
#undef TCTI_SCALAR_CLASS_NON_EL0
#undef TCTI_SCALAR_CLASS_UNCLASSIFIED
#undef TCTI_SCALAR_CLASS_REQUIRED
...
static const struct operation_spec operation_specs[] = {
	SPEC("ADR", 1, REG_PC,
	     "tcti_gadget_executes_complete_pc_relative_address_family"),
	SPEC("ADRP", 1, REG_PC,
	     "tcti_gadget_executes_complete_pc_relative_address_family"),
	...
	SPEC("ADD_addsub_shift", 2, REG_PC,
	     "tcti_gadget_executes_complete_add_sub_shifted_register_family"),
	...
	SPEC("ADD_addsub_ext", 2, REG_PC,
	     "tcti_gadget_executes_complete_add_sub_extended_register_family"),
	...
	SPEC("SUBS_addsub_ext", 2, REG_PC_FLAGS,
	     "tcti_gadget_executes_complete_add_sub_extended_register_family"),
	SPEC("ADC", 2, REG_PC,
	     "tcti_gadget_executes_complete_add_sub_with_carry_family"),
	...
	SPEC("AND_log_imm", 2, REG_PC,
	     "tcti_gadget_executes_complete_logical_immediate_family"),
	...
	SPEC("AND_log_shift", 2, REG_PC,
	     "tcti_gadget_executes_complete_logical_shifted_register_family"),
	...
	SPEC("BICS", 2, REG_PC_FLAGS,
	     "tcti_gadget_executes_complete_logical_shifted_register_family"),
	SPEC("MOVN", 2, REG_PC,
	     "tcti_gadget_executes_complete_move_wide_immediate_family"),
	SPEC("MOVZ", 2, REG_PC,
	     "tcti_gadget_executes_complete_move_wide_immediate_family"),
	SPEC("MOVK", 2, REG_PC,
	     "tcti_gadget_executes_complete_move_wide_immediate_family"),
	SPEC("SBFM", 2, REG_PC,
	     "tcti_gadget_executes_complete_bitfield_family"),
	SPEC("BFM", 2, REG_PC,
	     "tcti_gadget_executes_complete_bitfield_family"),
	SPEC("UBFM", 2, REG_PC,
	     "tcti_gadget_executes_complete_bitfield_family"),
	SPEC("EXTR", 2, REG_PC,
	     "tcti_gadget_executes_complete_extract_family"),
	SPEC("RBIT_int", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_1source_family"),
	...
	SPEC("CLS_int", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_1source_family"),
	SPEC("UDIV", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_2source_family"),
	SPEC("SDIV", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_2source_family"),
	SPEC("LSLV", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_2source_family"),
	...
	SPEC("RORV", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_2source_family"),
	SPEC("CRC32", 4, REG_PC,
	     "tcti_gadget_executes_complete_crc32_family"),
	SPEC("CRC32C", 4, REG_PC,
	     "tcti_gadget_executes_complete_crc32_family"),
	SPEC("MADD", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_3source_family"),
	SPEC("MSUB", 2, REG_PC,
	     "tcti_gadget_executes_complete_data_processing_3source_family"),
	...
	SPEC("CCMN_reg", 2, REG_PC_FLAGS,
	     "tcti_gadget_executes_complete_conditional_compare_family"),
	...
	SPEC("CSEL", 2, CONTROL_PC,
	     "tcti_gadget_executes_complete_conditional_select_family"),
	...
	SPEC("B_cond", 1, CONTROL_PC,
	     "tcti_gadget_executes_complete_conditional_branch_immediate_family"),
	SPEC("B_uncond", 1, REG_PC,
	     "tcti_gadget_executes_complete_unconditional_branch_immediate_family"),
	SPEC("BL", 1, REG_PC,
	     "tcti_gadget_executes_complete_unconditional_branch_immediate_family"),
	SPEC("BR", 1, REG_PC,
	     "tcti_gadget_executes_complete_unconditional_branch_register_family"),
	SPEC("BLR", 1, REG_PC,
	     "tcti_gadget_executes_complete_unconditional_branch_register_family"),
	SPEC("RET", 1, REG_PC,
	     "tcti_gadget_executes_complete_unconditional_branch_register_family"),
	SPEC("CBZ", 2, REG_PC,
	     "tcti_gadget_executes_complete_compare_branch_immediate_family"),
	SPEC("CBNZ", 2, REG_PC,
	     "tcti_gadget_executes_complete_compare_branch_immediate_family"),
	SPEC("TBZ", 1, REG_PC,
	     "tcti_gadget_executes_complete_test_branch_immediate_family"),
	SPEC("TBNZ", 1, REG_PC,
	     "tcti_gadget_executes_complete_test_branch_immediate_family"),
	...
	SPEC("NOP", 1, REG_PC,
	     "tcti_switch_executes_complete_hint_barrier_cache_family"),
	SPEC("YIELD", 1, REG_PC,
	     "tcti_switch_executes_complete_hint_barrier_cache_family"),
	SPEC("WFE", 1, REG_PC,
	     "tcti_switch_executes_complete_hint_barrier_cache_family"),
	...
	SPEC("CLREX", 1, SYSTEM_STATE,
	     "tcti_switch_executes_exclusive_monitor_clear"),
	SPEC("DSB", 1, BARRIER,
	     "tcti_switch_executes_complete_hint_barrier_cache_family"),
	SPEC("DMB", 1, BARRIER,
	     "tcti_switch_executes_complete_hint_barrier_cache_family"),
	...
	SPEC("SYS", 1, SYSTEM_STATE,
	     "tcti_switch_executes_complete_el0_system_registers"),
...
static struct tcti_scalar_operation_catalog_entry
	catalog[TCTI_SCALAR_OPERATION_CATALOG_EXPECTED_COUNT];
...
static bool valid_sha256_hex(
	const char digest[TCTI_SCALAR_OPERATION_SHA256_HEX_SIZE])
{
	size_t index;
...
static bool sha256_self_test(void)
{
	...
	char actual[TCTI_SCALAR_OPERATION_SHA256_HEX_SIZE];
	uint8_t digest[32];
...
static void initialize_catalog(void)
{
	...
	for (row = 0; row < sizeof(source_rows) / sizeof(source_rows[0]); row++) {
		...
		struct tcti_scalar_operation_catalog_entry *entry;
		...
		entry->proof_state = TCTI_SCALAR_OPERATION_UNPROVED;
		if (tcti_scalar_operation_source_sha256(
	...
	enum tcti_scalar_operation_catalog_error *error)
{
	...
	uint32_t known_obligations =
		...
		TCTI_SCALAR_OBLIGATION_PC |
		TCTI_SCALAR_OBLIGATION_FLAGS |
		TCTI_SCALAR_OBLIGATION_FAULTS |
		TCTI_SCALAR_OBLIGATION_ORDERING |
		TCTI_SCALAR_OBLIGATION_SYSTEM_STATE |
		TCTI_SCALAR_OBLIGATION_STRUCTURED_EXIT;

	if (error)
		*error = TCTI_SCALAR_OPERATION_CATALOG_OK;
	if (!entries && count)
		goto invalid_argument;
	if (!sha256_self_test())
		goto invalid_argument;
	if (count != TCTI_SCALAR_OPERATION_CATALOG_EXPECTED_COUNT) {
		if (error)
			*error = TCTI_SCALAR_OPERATION_CATALOG_WRONG_COUNT;
		return -1;
	}
	for (index = 0; index < count; index++) {
		const struct tcti_scalar_operation_catalog_entry *entry =
			&entries[index];
		const struct operation_spec *spec;
		char expected_sha256[TCTI_SCALAR_OPERATION_SHA256_HEX_SIZE];
		size_t spec_index;
		...
		if (entry->proof_state != TCTI_SCALAR_OPERATION_UNPROVED) {
			if (error)
				*error =
		...
		if (!valid_sha256_hex(entry->source_sha256) ||
		    tcti_scalar_operation_source_sha256(entry, expected_sha256) ||
	...
	}
	{
		...
		if (tcti_scalar_operation_catalog_sha256(
...
invalid_argument:
	if (error)
		*error = TCTI_SCALAR_OPERATION_CATALOG_INVALID_ARGUMENT;
	return -1;
}
