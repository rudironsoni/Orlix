/* OrlixKernel/kernel/cred_internal.h
 ...
 * This is the OrlixKernel-internal credential representation,
 * NOT the Linux UAPI struct cred.
 *
 * Tracks virtual UID/GID identity within Orlix boundaries.
...
/* Initialize a credential with Orlix default values
 * Uses deterministic virtual defaults, not host identity */
void cred_init_defaults(struct cred *cred);

/* Reset global credentials to Orlix defaults - for testing only */
