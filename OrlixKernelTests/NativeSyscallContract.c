...
int native_syscall_contract_linux_sysdeps_inventory_is_kernel_owned(void) {
    ...
    static const struct required_syscall_class required_classes[] = {
        ...
        {__NR_preadv, SYSCALL_CAPABILITY_FD},
        {__NR_pwritev, SYSCALL_CAPABILITY_FD},
        {__NR_sendfile, SYSCALL_CAPABILITY_FD},
        {__NR_splice, SYSCALL_CAPABILITY_FD},
        {__NR_tee, SYSCALL_CAPABILITY_FD},
        {__NR_vmsplice, SYSCALL_CAPABILITY_FD},
        ...
        {__NR_truncate, SYSCALL_CAPABILITY_FD},
        {__NR_fallocate, SYSCALL_CAPABILITY_FD},
        ...
        {__NR_sync_file_range, SYSCALL_CAPABILITY_FD},
        {__NR_preadv2, SYSCALL_CAPABILITY_FD},
        {__NR_pwritev2, SYSCALL_CAPABILITY_FD},
...
int native_syscall_contract_registers_native_artifact_descriptor(void) {
    ...
    if (native_register_artifact("//sbin///init", "/orlix/packages/core/init.xcframework",
    ...
    if (strcmp(program.path, "/sbin/init") != 0 ||
        strcmp(program.artifact_path, "/orlix/packages/core/init.xcframework") != 0 ||
