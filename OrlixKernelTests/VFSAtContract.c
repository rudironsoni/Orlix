...
static void vfs_contract_release_lookup_child(struct task *parent, struct task *child) {
    if (!child) {
        return;
    }
...
int vfs_contract_proc_self_mountinfo_uses_linux_shaped_optional_fields(void) {
    ...
    if (!vfs_contract_content_contains(content, "1 0 0:1 / / rw,relatime - orlix-root orlix-root rw\n") ||
...
int vfs_contract_slave_child_unmount_does_not_propagate_to_shared_peer(void) {
    ...
    if (vfs_contract_write_file("/tmp/vfs-mntns-child-source/file", "slave-child") != 0) {
        goto out;
    }
    if (mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-peer-a", NULL, MS_BIND | MS_SHARED, NULL) != 0 ||
        mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-peer-b", NULL, MS_BIND | MS_SHARED, NULL) != 0 ||
    ...
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-b/child/file", "slave-child") != 0) {
        goto out;
    }
...
static int vfs_contract_statmount_attrs_for_target(const char *target, uint64_t *attrs) {
    struct mnt_id_req req;
    ...
    if (vfs_contract_read_proc_file("/proc/self/mountinfo", content, sizeof(content)) != 0 ||
        vfs_contract_mountinfo_ids_for_target(content, target, &mount_id, &parent_id) != 0) {
        return -1;
    }
    ...
    if (!st->mnt_point || strcmp(vfs_contract_statmount_string(st, st->mnt_point), target) != 0) {
        errno = ENODATA;
        return -1;
    }
...
int vfs_contract_mount_setattr_recursive_attrs_visible_in_statmount(void) {
    ...
    if (vfs_mount_setattr(AT_FDCWD, "/tmp/vfs-mntns-target", AT_RECURSIVE,
        ...
        vfs_contract_statmount_attrs_for_target("/tmp/vfs-mntns-target/child", &child_attrs) != 0) {
        goto out;
    }
...
int vfs_contract_listmount_walks_mount_subtree_by_parent_id(void) {
    ...
    if (vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source/child", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source/child/grand", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-child-source", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-child-source/grand", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-grandchild-source", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-target", 0700)) != 0 ||
        vfs_contract_write_file("/tmp/vfs-mntns-grandchild-source/file", "listmount") != 0) {
        goto out;
    }
    if (mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-target", NULL, MS_BIND, NULL) != 0 ||
        mount("/tmp/vfs-mntns-child-source", "/tmp/vfs-mntns-target/child", NULL, MS_BIND, NULL) != 0 ||
    ...
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-target/child/grand/file", "listmount") != 0 ||
        vfs_contract_read_proc_file("/proc/self/mountinfo", content, sizeof(content)) != 0 ||
        vfs_contract_mountinfo_ids_for_target(content, "/tmp/vfs-mntns-target",
                                              &target_id, &target_parent_id) != 0 ||
        vfs_contract_mountinfo_ids_for_target(content, "/tmp/vfs-mntns-target/child",
                                              &child_id, &child_parent_id) != 0 ||
        vfs_contract_mountinfo_ids_for_target(content, "/tmp/vfs-mntns-target/child/grand",
...
int vfs_contract_open_tree_clone_attach_propagates_private_subtree_to_shared_and_slave(void) {
    ...
    vfs_contract_cleanup_mount_namespace_paths();
    if (vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source/grand", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source/moved", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-child-source", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-target", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-a", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-b", 0700)) != 0 ||
    ...
    if (vfs_contract_write_file("/tmp/vfs-mntns-child-source/file", "detached-propagated") != 0) {
        goto out;
    }
    ...
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-a/moved/grand/file",
                                     "detached-propagated") != 0 ||
        vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-b/moved/grand/file",
                                     "detached-propagated") != 0 ||
        vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-c/moved/grand/file",
                                     "detached-propagated") != 0) {
        goto out;
    }
...
int vfs_contract_open_tree_clone_survives_source_namespace_teardown(void) {
    ...
    if (vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-target", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-a", 0700)) != 0 ||
        vfs_contract_write_file("/tmp/vfs-mntns-parent-source/file", "source-ns-detached") != 0) {
        goto out;
    }
    ...
    if (syscall_dispatch_impl(__NR_move_mount, tree_fd, (long)(uintptr_t)"",
        ...
        vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-a/file", "source-ns-detached") != 0) {
        task_set_current(parent);
        goto out;
    }
    task_set_current(parent);
...
int vfs_contract_shared_move_updates_proc_mountinfo_for_peer(void) {
    ...
    if (vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-parent-source", 0700)) != 0 ||
        ...
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-a", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-b", 0700)) != 0 ||
        vfs_contract_write_file("/tmp/vfs-mntns-child-source/file", "move-mountinfo") != 0) {
        goto out;
    }
    if (mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-peer-a", NULL, MS_BIND | MS_SHARED, NULL) != 0 ||
        mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-peer-b", NULL, MS_BIND | MS_SHARED, NULL) != 0 ||
    ...
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-b/child/file", "move-mountinfo") != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-a/moved", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-b/moved", 0700)) != 0 ||
        vfs_contract_read_proc_file("/proc/self/mountinfo", content, sizeof(content)) != 0 ||
        !vfs_contract_content_contains(content, " /tmp/vfs-mntns-peer-a/child ") ||
        !vfs_contract_content_contains(content, " /tmp/vfs-mntns-peer-b/child ")) {
        errno = ENODATA;
        goto out;
    }
    {
    ...
    if (vfs_contract_read_proc_file("/proc/self/mountinfo", content, sizeof(content)) != 0 ||
        !vfs_contract_content_contains(content, " /tmp/vfs-mntns-peer-a/moved ") ||
        !vfs_contract_content_contains(content, " /tmp/vfs-mntns-peer-b/moved ") ||
        vfs_contract_content_contains(content, " /tmp/vfs-mntns-peer-a/child ") ||
        vfs_contract_content_contains(content, " /tmp/vfs-mntns-peer-b/child ")) {
        errno = ENOMSG;
        goto out;
...
int vfs_contract_slave_child_move_does_not_propagate_to_shared_peer(void) {
    ...
    if (vfs_contract_write_file("/tmp/vfs-mntns-child-source/file", "slave-move") != 0) {
        goto out;
    }
    if (mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-peer-a", NULL, MS_BIND | MS_SHARED, NULL) != 0 ||
        mount("/tmp/vfs-mntns-parent-source", "/tmp/vfs-mntns-peer-b", NULL, MS_BIND | MS_SHARED, NULL) != 0 ||
    ...
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-b/child/file", "slave-move") != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-a/moved", 0700)) != 0 ||
        vfs_contract_ignore_exists(mkdir_impl("/tmp/vfs-mntns-peer-b/moved", 0700)) != 0) {
        goto out;
    }
    ...
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-a/moved/file", "slave-move") != 0) {
        errno = ENOMSG;
        goto out;
    }
    if (vfs_contract_read_file_exact("/tmp/vfs-mntns-peer-b/child/file", "slave-move") != 0) {
