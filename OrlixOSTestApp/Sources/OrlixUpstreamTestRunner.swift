...
struct OrlixUpstreamTestRunSpec: Equatable, Sendable {
    ...
    static let kernelTCTINativeObservationDiagnostic = OrlixUpstreamTestRunSpec(
        ...
        timeout: 300,
        kernelCommandLineSuffix:
            "kunit.filter_glob=orlix-tcti-native-observation " +
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-native-observation",
        hostDirectoryFixture: true
    )

    static let kernelTCTINativeObservationProductionDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
    ...
    static let kernelTCTIBaseLoadStoreDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-load-store-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIAdvsimdLoadStoreDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-advsimd-structure-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIBaseAtomicDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-atomic-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIBaseAddSubDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-add-sub-source-bound",
        hostDirectoryFixture: true
    )
    ...
    static let kernelTCTIBaseExceptionsDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-exceptions-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIBaseConditionalDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-conditional-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIBaseBitfieldUnaryDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-bitfield-unary-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIBaseMultiplyDivideDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-base-multiply-divide-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIAdvSIMDCryptoDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-advsimd-crypto-source-bound",
        hostDirectoryFixture: true
    )
    ...
    static let kernelTCTIAdvSIMDFPDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-advsimd-fp-source-bound",
        hostDirectoryFixture: true
    )

    static let kernelTCTIScalarFPDiagnostic = OrlixUpstreamTestRunSpec(
        suite: .kernel,
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix:
            ...
            "orlix.kselftest=boot_profile_contract",
        expectedKUnitSuite: "orlix-tcti-scalar-fp-source-bound",
        hostDirectoryFixture: true
    )
    ...
    static let kernelTCTICrypto = OrlixUpstreamTestRunSpec(
        ...
        completionMarker: "ORLIX-KSELFTEST-END",
        timeout: 300,
        kernelCommandLineSuffix: "orlix.kselftest=orlix_tcti_crypto_probe"
    )
...
final class OrlixUpstreamTestSessionRunner: @unchecked Sendable {
    ...
    private let injectedSession: OrlixKernelSession?
    private let parser: OrlixUpstreamTestOutputParser

    init(
        spec: OrlixUpstreamTestRunSpec,
        session: OrlixKernelSession? = nil,
...
enum OrlixOSTestAppLaunchRuntimeRunner {
    ...
    static func runIfRequested() {
		...
		case "orlixPayloadE2fsprogs":
			output = try OrlixOSDistributionE2fsprogsRuntimeProof().run()
        case "orlixPayloadE2fsprogsMaterialization":
            output = try OrlixOSDistributionE2fsprogsRuntimeProof(
                script: OrlixOSDistributionE2fsprogsRuntimeProof
                    .materializationScript,
                requiredMarkers: OrlixOSDistributionE2fsprogsRuntimeProof
...
liveImageReference: "registry.k8s.io/e2e-test-images/busybox:1.29-4",
        ...
        case "ociVirtioFS":
            ...
            default:
                throw OrlixOSTestAppLaunchRuntimeRunnerError.unknownSpec(specName)
            }
...
private enum OrlixOSTestAppLaunchRuntimeRunnerError: Error, CustomStringConvertible {
...
private final class OrlixOCIDerivedStdioRuntimeProof: @unchecked Sendable {
    ...
    private let recorder = OrlixOSProofOutputRecorder()
    ...
    func run() throws -> String {
        let sourceRoot = OrlixOSTestAppLaunchRuntimeRunner.fixtureRoot()
        ...
        let fixture = OrlixOSEnvironmentFixture(root: copiedRoot)
...
private final class OrlixOSDistributionE2fsprogsRuntimeProof: @unchecked Sendable {
	private static let defaultTimeout: TimeInterval = 120
	private static let versionMarkers = [
		"ORLIX_OS_DISTRIBUTION_E2FSPROGS_MKE2FS_OK",
		"ORLIX_OS_DISTRIBUTION_E2FSPROGS_MKFS_EXT4_OK",
		"ORLIX_OS_DISTRIBUTION_E2FSPROGS_DEBUGFS_OK",
		"ORLIX_OS_DISTRIBUTION_E2FSPROGS_DONE",
	]
	...
	private static let versionScript = [
        ...
        "printf 'ORLIX_OS_DISTRIBUTION_E2FSPROGS_%s_OK\\n' MKE2FS",
        "printf 'ORLIX_OS_DISTRIBUTION_E2FSPROGS_%s_OK\\n' MKFS_EXT4",
        "printf 'ORLIX_OS_DISTRIBUTION_E2FSPROGS_%s_OK\\n' DEBUGFS",
        "printf 'ORLIX_OS_DISTRIBUTION_E2FSPROGS_%s_OK\\n' E2FSCK",
		"printf 'ORLIX_OS_DISTRIBUTION_E2FSPROGS_%s\\n' DONE",
	].joined(separator: "; ")
	...
	init(
		script: String = OrlixOSDistributionE2fsprogsRuntimeProof.versionScript,
		requiredMarkers: [String] = OrlixOSDistributionE2fsprogsRuntimeProof
			.versionMarkers,
		timeout: TimeInterval = OrlixOSDistributionE2fsprogsRuntimeProof.defaultTimeout
	) {
		self.script = script
    ...
    @unchecked Sendable
{
	...
	private func validateGeneratedAlpineRuntime(
        ...
        let terminal = OrlixTerminalSession()
        let recorder = OrlixOSProofOutputRecorder()
        let output = terminal.attachOutput { [recorder] data in
            recorder.append(data)
        }
        defer { output.cancel() }
	...
	private static func persistentLinuxMaterializationRoot() throws -> URL {
		...
		return supportRoot.appendingPathComponent(
			"OrlixOSProofs/alpine-linux-materialization",
			isDirectory: true
		)
	}
...
private struct OrlixOSEnvironmentFixture {
	let root: URL
...
private final class OrlixOSProofOutputRecorder: @unchecked Sendable {
    private let lock = NSLock()
    private var storage = Data()
