...
final class OrlixKernelUpstreamTests: XCTestCase {
    ...
    func testVirtioNetDeviceProbeCompletesThroughOrlixOSTerminalSession() throws {
        ...
        XCTAssertTrue(output.contains("AF_PACKET send advances virtio-net tx_packets"))
        XCTAssertTrue(output.contains("virtio-net RX queue advances rx_packets"))
        ...
        throws
    {
        ...
        XCTAssertTrue(output.contains("probe step mounted_root_supports_create_write_readback"))
        ...
        XCTAssertTrue(output.contains("probe step mount_host_virtiofs_ro"))
