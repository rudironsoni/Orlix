...
This directory is the canonical Orlix knowledge graph. It models the product, software components, architecture decisions, initiatives, product capabilities, reusable concepts, and source provenance as typed Markdown pages.
...
```text
objects/   products, components, decisions, initiatives, and capabilities
