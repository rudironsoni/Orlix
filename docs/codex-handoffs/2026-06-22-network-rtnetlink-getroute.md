...
The Orlix Linux networking selftest now proves standard rtnetlink IPv4 route
...
- `docs/plans/active/oci-derived-environments-virtio-plane/codex-handoffs/2026-06-22-handoff-network-rtnetlink-getroute.md`
...
Continue networking work through Linux-owned interfaces: namespace isolation,
route mutation/error semantics, or virtio-net packet proof. Do not expose Darwin
