...
tags:
  ...
  - architecture
updated: 2026-07-15
summary: "SFTP Files Feature-First Refactor (Spec)."
applies:
...
This refactor is intentionally scoped to the Files feature only. It does not require converting the rest of Orlix immediately.
...
### Unit Tests
Create:
`OrlixTests/Features/RemoteFiles/`
