...
3. **P2, unlock the product foundations.** After the pinned simulator proof, integrate the commercially approved Herdr platform, implement and prove OrlixMachine isolation, promote OrlixTCTI, and validate mobile presentation. Authorized OrlixTCTI device proof remains optional until an operator selects it for a candidate.
4. **P3, validate and publish the mobile terminal release stage.** The first public mobile terminal stage proves terminal, Herdr, OrlixMachine, OrlixTCTI, and mobile presentation. It does not claim OCI or Docker behavior, and it may finish before OCI. The three-stage Orlix release epic does not finish until the later OCI and native macOS stages do.
5. **P4, complete OCI lifecycle and Docker compatibility.** Build on proven OrlixMachine isolation, imported OCI content, and the released terminal foundation.
...
| [Orlix TCTI](../objects/epic/doing/orlix-tcti.md) | [Prove TCTI product execution](../objects/story/doing/prove-tcti-product-execution.md) | P1-P2 | Current structured task envelope | Native Herdr integration, OrlixMachine, OCI lifecycle, and the mobile terminal release |
...
| [Native app foundation](../objects/epic/doing/native-app-foundation.md) | [Deliver Orlix machines](../objects/story/doing/deliver-orlix-machines.md) | P1-P2 | OrlixMachine session binding and pinned OrlixTCTI simulator proof | OCI lifecycle and mobile terminal release |
| [Orlix release](../objects/epic/doing/orlix-release.md) | [Validate and publish the mobile terminal release](../objects/story/doing/validate-and-publish-mobile-terminal-release.md) | P3 | Native application, OrlixMachine, and OrlixTCTI product stories | Mobile container release |
| [OCI-derived environments](../objects/epic/doing/oci-derived-environments.md) | [Deliver OCI environment lifecycle](../objects/story/doing/deliver-oci-environment-lifecycle.md) | P1, P4 | OrlixMachine lifecycle and isolation | Mobile container release |
...
| P1 | [Complete the pinned simulator TCTI ladder](../objects/task/doing/complete-pinned-simulator-tcti-ladder.md) | Complete AArch64 ISA-on-ISA coverage | Herdr integration, OrlixMachine lifecycle, authorized OrlixTCTI device proof |
| P1 | [Bind OrlixMachine sessions through OrlixOS](../objects/task/doing/bind-orlix-machine-sessions-through-orlixos.md) | Existing terminal transport and console policy | OrlixMachine lifecycle and mobile presentation proof |
...
| P2 | [Implement namespaced OrlixMachine lifecycle](../objects/task/todo/implement-namespaced-orlix-machine-lifecycle.md) | OrlixMachine session binding and pinned OrlixTCTI simulator proof | Concurrent OrlixMachine isolation |
| P2 | [Prove concurrent OrlixMachine isolation](../objects/task/todo/prove-concurrent-orlix-machine-isolation.md) | Namespaced OrlixMachine lifecycle | OCI runtime lifecycle and terminal simulator proof |
...
| P3 | [Validate the mobile terminal simulator product](../objects/task/doing/validate-mobile-terminal-simulator-product.md) | Commercial Herdr topology, mobile presentation, OrlixMachine isolation, OrlixTCTI product default | Optional device proof and terminal archive |
...
| P4 | [Implement OCI runtime lifecycle](../objects/task/todo/implement-oci-runtime-lifecycle.md) | OCI image import and OrlixMachine isolation | Docker compatibility |
