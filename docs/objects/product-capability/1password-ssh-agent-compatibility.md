...
updated: 2026-07-15
status: proposed
summary: "1Password SSH Agent Compatibility Integration (Draft Spec)."
part_of:
...
## Problem
Orlix currently authenticates with passwords or private keys stored in Keychain. Users who keep keys in 1Password want agent-based signing instead of importing private keys.
