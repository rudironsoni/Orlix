...
- `Full-app lock`: Orlix requires biometric authentication when the app becomes active.
...
## Problem
Orlix currently protects credentials in Keychain, but opening the app or selecting a server does not require a local user-presence check. On shared devices this increases exposure risk.
...
- iOS server open path: `Orlix/Views/iOS/iOSContentView.swift`
- iOS session open API: `Orlix/Managers/ConnectionSessionManager.swift`
- macOS server connect UI path: `Orlix/ContentView.swift`
- macOS tab open API: `Orlix/Managers/TerminalTabManager.swift`

### Server metadata + sync
- Server model: `Orlix/Models/Server.swift`
- Server CloudKit encode/decode: `Orlix/Models/Server+CloudKit.swift`
...
- General settings: `Orlix/Views/Settings/GeneralSettingsView.swift`
- Settings navigation: `Orlix/Views/Settings/SettingsView.swift`
- Server edit form: `Orlix/Views/ServerDetail/ServerFormSheet.swift`
...
Update:
- `Codable` keys and init/encode in `Orlix/Models/Server.swift`
- CloudKit record read/write in `Orlix/Models/Server+CloudKit.swift`
- All manual `Server(...)` rebuild callsites in `Orlix/Managers/ServerManager.swift`
...
## Architecture
Create:
- `Orlix/Services/Security/BiometricAuthService.swift`
- `Orlix/Managers/AppLockManager.swift`
...
## UI Changes
### Server form
File: `Orlix/Views/ServerDetail/ServerFormSheet.swift`
...
### Settings
Files:
- `Orlix/Views/Settings/SettingsView.swift`
- `Orlix/Views/Settings/GeneralSettingsView.swift`

Add security section in General:
- `Require Face ID to open Orlix` toggle
...
- `Orlix/Views/Security/AppLockGateView.swift`
...
## Integration Points
### iOS
- `Orlix/Views/iOS/iOSContentView.swift`
...
### macOS
- `Orlix/ContentView.swift`
  - Gate connect actions before mutating connected state.
- `Orlix/Views/Tabs/ConnectionTabsView.swift`
...
### Unit tests
Add test files:
- `OrlixTests/BiometricAuthServiceTests.swift`
- `OrlixTests/AppLockManagerTests.swift`
