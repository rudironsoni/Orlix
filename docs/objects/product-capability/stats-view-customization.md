...
updated: 2026-07-15
status: implemented
summary: "Stats View Customization (Spec)."
part_of:
...
### Domain Model
Create:
- `Orlix/Features/Stats/Domain/Preferences.swift`
...
### Stats Data Model
Extend:
- `Orlix/Features/Stats/Domain/ServerStats.swift`
- `Orlix/Features/Stats/Domain/HardwareProfile.swift`
- `Orlix/Features/Stats/Domain/GPU.swift`
...
### Application Store
Create:
- `Orlix/Features/Stats/Application/PreferencesStore.swift`
...
Current UI files:
- `Orlix/Features/Stats/UI/ServerStatsView.swift` - lifecycle/container
- `Orlix/Features/Stats/UI/ServerStatsDashboard.swift` - collection lifecycle, retry overlay, and collector action handoff
- `Orlix/Features/Stats/UI/StatsBlocksContent.swift` - ordered visible blocks, style selection, previews, and page layout
- `Orlix/Features/Stats/UI/StatsDashboardCards.swift` - compact/detailed dashboard card layouts
- `Orlix/Features/Stats/UI/ClassicStatsContent.swift` - classic layout
- `Orlix/Features/Stats/UI/StatsVisualStyle.swift` - style tokens, platform color constants, and appearance resolution
- `Orlix/Features/Stats/UI/StatsFormatters.swift` - shared display formatting
- `Orlix/Features/Stats/UI/StatsPreviewFixture.swift` - appearance preview sample data
- `Orlix/Features/Stats/UI/DetailPresentation.swift` - shared detail presentation API
- `Orlix/Features/Stats/UI/DetailPresentation+iOS.swift` - iOS sheet presentation modifiers
- `Orlix/Features/Stats/UI/DetailPresentation+macOS.swift` - macOS sheet chrome and search field
- `Orlix/Features/Stats/UI/AppearanceSettings.swift`
- `Orlix/Features/Stats/UI/Components/StatsCardComponents.swift`
- `Orlix/Features/Stats/UI/Components/StatsChartsAndMeters.swift`
- `Orlix/Features/Stats/UI/Details/StatsDetailRows.swift`
- `Orlix/Features/Stats/UI/Details/ProcessDetails.swift`
- `Orlix/Features/Stats/UI/Details/DockerDetails.swift`
- `Orlix/Features/Stats/UI/Details/HardwareDetails.swift`
...
Update:
- `Orlix/Features/Settings/UI/GeneralSettingsView.swift`
