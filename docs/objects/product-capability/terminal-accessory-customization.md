...
All new iOS customization/snippet sheets should match existing Orlix sheet patterns:
...
### Data Model
Create:
- `Orlix/Models/TerminalAccessoryModels.swift`
...
### Managers / Services
Create:
- `Orlix/Managers/TerminalAccessoryPreferencesManager.swift` (`@MainActor`, `ObservableObject`)

Update:
- `Orlix/Services/CloudKit/CloudKitManager.swift`
...
Update:
- `Orlix/Views/Settings/TerminalSettingsView.swift`
- Add:
  - `Orlix/Views/Settings/TerminalAccessoryCustomizationView.swift`
  - `Orlix/Views/Settings/TerminalSnippetLibraryView.swift`
  - `Orlix/Views/Settings/TerminalSnippetFormView.swift`
