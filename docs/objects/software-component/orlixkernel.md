...
Upstream Linux port compiled into private static `OrlixKernel.xcframework` with identifier `com.rudironsoni.orlix.os.kernel`. It is an implementation dependency of `OrlixOS.xcframework`, not a public SDK.
