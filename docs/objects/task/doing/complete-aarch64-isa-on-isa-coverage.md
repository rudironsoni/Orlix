...
| `SCALAR_FP` | 266 | The 140 always-on FEAT_FP S/D leaves are proved. Before ingest, the host mnemonic oracle checks results, FPCR, NZCV, and preserved registers. Coverage includes sticky FPSR, quiet-NaN compare IOC, FRINTI/FRINTX IXC, FDIV DZC, FZ subnormal IDC, NaN, DN, signed-zero min/max, conditions, aliases, poison, and FMOV lanes. The 126 FP16, FPRCVT, FRINTTS, JSCVT, and BF16 leaves remain complete-target blockers and unadvertised. |
