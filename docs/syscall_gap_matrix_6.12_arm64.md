...
Generated from vendored Linux UAPI and `OrlixKernel/runtime/syscall.c`.
...
| 117 | `ptrace` | implemented:process | `OrlixKernelTests/PtraceContract.c`, `OrlixKernelTests/PtraceTests.m` |
