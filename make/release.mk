...
ORLIX_RELEASE_XCODE_VERSION_FILE := $(abspath $(dir $(lastword $(MAKEFILE_LIST)))../.xcode-version)
ORLIX_RELEASE_XCODE_VERSION ?= $(shell tr -d '[:space:]' < $(ORLIX_RELEASE_XCODE_VERSION_FILE))
