				  ...
				  FILE *output)
{
	...
	if (fputs("TCTI_A64_ASL_AVAILABILITY_SOURCE(\"inline_aarchmrs_operations_v1\", \"a1ad2c6538a47cd97d8762791ac5af88bce1d5f6aff096c9b77aef853e76acfe\", \"shared_asl_absent_blocking\")\n", output) == EOF)
		goto out;
	for (index = 0; index < inventory.leaf_count; index++) {
		...
		if (fputs("TCTI_A64_ASL_AVAILABILITY_ROW(", output) == EOF ||
		    ...
		    fprintf(output, ", \"operations/%s\", %zuU, %zuU, \"shared_asl_absent_blocking\")\n",
